...
void CConfig::SetDefaults( void )
{
    ...
    /* PLUM edit start */
    KeyMaps.at(EVENT_PLUM_VIEW)    = SDLK_LALT;
    KeyMaps.at(EVENT_PLUM_REFRESH) = SDLK_LSHIFT;
    KeyMaps.at(EVENT_PLUM_HELP)    = SDLK_h;
    KeyMaps.at(EVENT_SELECT_ALL)   = SDLK_s;
    /* PLUM edit finish */
    ...
    /* PLUM edit start */
    JoyMaps.at(EVENT_PLUM_VIEW)    = 6;
    JoyMaps.at(EVENT_PLUM_REFRESH) = 7;
    JoyMaps.at(EVENT_PLUM_HELP)    = 8;
    //JoyMaps.at(EVENT_CFG_ITEM)   = 7;
    /* PLUM edit finish */
    
    //JoyMaps.at(EVENT_SET_ONE)    = 9;
	//JoyMaps.at(EVENT_SET_ALL)    = 10;
    JoyMaps.at(EVENT_SELECT)     = 11;
    //JoyMaps.at(EVENT_BACK)       = 12;
    JoyMaps.at(EVENT_QUIT)       = 13;
    ...
    /* PLUM edit start */
    PathButtons.at(EVENT_PLUM_VIEW)      = "images/button_plum_view.png";
    PathButtons.at(EVENT_PLUM_REFRESH)   = "images/button_plum_refresh.png";
    PathButtons.at(EVENT_PLUM_HELP)      = "images/button_plum_help.png";
    PathButtons.at(EVENT_SELECT_ALL)     = "images/button_selectall.png";
    /* PLUM edit finish */
    ...
    PreviewXpos			= PREVIEW_X;
    PreviewYpos			= PREVIEW_Y;
}
    ...
    if (fin.is_open())
    {
        while (!fin.eof())
        {
            ...
            if (line.length() > 0)
            {
                ...
                /* PLUM edit start */
                LOAD_INT( OPT_USE_FAVOURITE_SERVER, UseFavouriteServer );
                /* PLUM edit finish */
                ...
                /* PLUM edit start */
                LOAD_INT( OPT_PREVIEW_X,            PreviewXpos );
                LOAD_INT( OPT_PREVIEW_Y,            PreviewYpos );
                //printf("xpos is now %d\n", PreviewXpos);
                /* PLUM edit finish */
                ...
                //LOAD_STR( OPT_PATH_POINTER,         PathPointer );
                LOAD_STR( OPT_PATH_SELECTPOINTER,   PathSelectPointer );
                ...
                /* PLUM edit start */
				LOAD_STR( OPT_PATH_SWITCH_VIEW,     PathButtons.at(EVENT_PLUM_VIEW) );
				LOAD_STR( OPT_PATH_REFRESH,     	PathButtons.at(EVENT_PLUM_REFRESH) );
				LOAD_STR( OPT_PATH_HELP,     		PathButtons.at(EVENT_PLUM_HELP) );
				LOAD_STR( OPT_PATH_SELECT_ALL,     	PathButtons.at(EVENT_SELECT_ALL) );
				/* PLUM edit finish */
                ...
                /* PLUM edit start */
                LOAD_KEY( OPT_KEYSWITCHVIEW,        KeyMaps.at(EVENT_PLUM_VIEW) );
                LOAD_KEY( OPT_KEYREFRESH,           KeyMaps.at(EVENT_PLUM_REFRESH) );
                LOAD_KEY( OPT_KEYHELP,	            KeyMaps.at(EVENT_PLUM_HELP) );
                LOAD_KEY( OPT_KEYSELECT_ALL,	        KeyMaps.at(EVENT_SELECT_ALL) );
                /* PLUM edit finish */
                ...
                /* PLUM edit start */
                LOAD_KEY( OPT_JOYSWITCHVIEW,        JoyMaps.at(EVENT_PLUM_VIEW) );
                LOAD_KEY( OPT_JOYREFRESH,           JoyMaps.at(EVENT_PLUM_REFRESH) );
                LOAD_KEY( OPT_JOYHELP,           	JoyMaps.at(EVENT_PLUM_HELP) );
                /* PLUM edit finish */
...
int8_t CConfig::Save( const string& location )
{
    ...
    if (fout.is_open())
    {
        ...
        /* PLUM edit start */
        SAVE_INT( OPT_USE_FAVOURITE_SERVER, HELP_USE_FAVOURITE_SERVER, 	UseFavouriteServer );
        /* PLUM edit finish */
        ...
        /* PLUM edit start */
        SAVE_INT( OPT_PREVIEW_X,	        HELP_PREVIEW_X,				PreviewXpos );
        SAVE_INT( OPT_PREVIEW_Y,          	HELP_PREVIEW_Y,				PreviewYpos );
        /* PLUM edit finish */
        ...
        /* PLUM edit start */
        SAVE_STR( OPT_PATH_SWITCH_VIEW,     HELP_PATH_SWITCH_VIEW,      PathButtons.at(EVENT_PLUM_VIEW) );
        SAVE_STR( OPT_PATH_REFRESH,         HELP_PATH_REFRESH,          PathButtons.at(EVENT_PLUM_REFRESH) );
        SAVE_STR( OPT_PATH_HELP,         	HELP_PATH_HELP,          	PathButtons.at(EVENT_PLUM_HELP) );
        SAVE_STR( OPT_PATH_SELECT_ALL,      HELP_PATH_SELECT_ALL,       PathButtons.at(EVENT_SELECT_ALL) );
        /* PLUM edit finish */
        ...
        /* PLUM edit start */
        SAVE_STR( OPT_KEYSWITCHVIEW,        GET_KEY_NAME(EVENT_PLUM_VIEW),    KeyMaps.at(EVENT_PLUM_VIEW) );
        SAVE_STR( OPT_KEYREFRESH,           GET_KEY_NAME(EVENT_PLUM_REFRESH), KeyMaps.at(EVENT_PLUM_REFRESH) );
        SAVE_STR( OPT_KEYHELP,           	GET_KEY_NAME(EVENT_PLUM_HELP), 	  KeyMaps.at(EVENT_PLUM_HELP) );
        SAVE_STR( OPT_KEYSELECT_ALL,        GET_KEY_NAME(EVENT_SELECT_ALL),   KeyMaps.at(EVENT_SELECT_ALL) );
        /* PLUM edit finish */
        ...
        /* PLUM edit start */
        SAVE_INT( OPT_JOYSWITCHVIEW,        HELP_DEFAULT,                   JoyMaps.at(EVENT_PLUM_VIEW) );
        SAVE_INT( OPT_JOYREFRESH,           HELP_DEFAULT,                   JoyMaps.at(EVENT_PLUM_REFRESH) );
        SAVE_INT( OPT_JOYHELP,	            HELP_DEFAULT,                   JoyMaps.at(EVENT_PLUM_HELP) );
        /* PLUM edit finish */
