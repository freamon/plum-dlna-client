...
/* PLUM edit start */
#define OPT_USE_FAVOURITE_SERVER       "use_favourite_server"
#define HELP_USE_FAVOURITE_SERVER      "(Not yet implemented)"
/* PLUM edit finish */
...
/* PLUM edit start */
#define OPT_PREVIEW_X              	"preview_x"
#define OPT_PREVIEW_Y               "preview_y"
/* PLUM edit finish */
...
/* PLUM edit start */
#define HELP_PREVIEW_X				"x co-ordinate of preview area"
#define HELP_PREVIEW_Y				"y co-ordinate of preview area"
/* PLUM edit finish */
...
/* PLUM edit start */
#define OPT_PATH_SWITCH_VIEW        "image_switchview"
#define HELP_PATH_SWITCH_VIEW       "Path to button graphic for switching between view local filesystem and media servers"

#define OPT_PATH_REFRESH            "image_refresh"
#define HELP_PATH_REFRESH           "Path to button graphic for refreshing list of available media servers"

#define OPT_PATH_HELP				"image_help"
#define HELP_PATH_HELP           	"Path to button graphic for displaying help with controls"

#define OPT_PATH_SELECT_ALL				"select_all"
#define HELP_PATH_SELECT_ALL           	"Path to button graphic for selecting all files"
/* PLUM edit finish */
...
/* PLUM edit start */
#define OPT_KEYSWITCHVIEW           "key_switchview"
#define OPT_KEYREFRESH              "key_refresh"
#define OPT_KEYHELP              	"key_help"
#define OPT_KEYSELECT_ALL			"key_selectall"
/* PLUM edit finish */
...
/* PLUM edit start */
#define OPT_JOYSWITCHVIEW           "button_switchview"
#define OPT_JOYREFRESH              "button_refresh"
#define OPT_JOYHELP		            "button_help"
/* PLUM edit finish */
...
enum EVENT_T {
	...
	EVENT_PLUM_VIEW,    /**<  5 Toggle between browsing media servers and local filesystem */
	EVENT_PLUM_REFRESH, /**<  6 Start a new search for media servers */
	EVENT_PLUM_RESET,	/**<  7 Internal: switch from MODE_PLUM_BROWSE back to MODE_PLUM_SEARCH */
	EVENT_PLUM_HELP,	/**<  8 Toggle help mode on/off */
	EVENT_SELECT_ALL,	/**<  9 Grab all URLs for a playlist */
	
	EVENT_SELECT,       /**< 10 Select the current item. */
    //EVENT_BACK,         /**< 13 Go back from the current mode and return to the previous mode. */
    EVENT_QUIT,         /**< 11 Quit the launcher. */
    
    //EVENT_CFG_APP,      /**< 15 Enter mode to configure the launcher. */
    //EVENT_CFG_ITEM,     /**< 16 Enter mode to configure an entry. */
    //EVENT_SET_ONE,      /**< 17 For an argument set selected value for the current entry. */
    //EVENT_SET_ALL,      /**< 18 For an argument set selected value for the all entry. */
    
    EVENT_TOTAL,        /**< 12 Total number of events. */
    EVENT_NONE          /**< 13 No event. */
    /* PLUM edit finish */
};
...
class CConfig : public CBase
{
    public:
        ...
        /* PLUM edit start */
        uint16_t			PreviewXpos;          /**< CONFIGURABLE Refer to HELP_PREVIEW_X */
        uint16_t			PreviewYpos;          /**< CONFIGURABLE Refer to HELP_PREVIEW_Y */
        /* PLUM edit finish */
        ...
        /* PLUM edit start */
        bool				UseFavouriteServer;		/**< CONFIGURABLE Refer to HELP_USE_FAVOURITE_SERVER */
        /* PLUM edit finish */
